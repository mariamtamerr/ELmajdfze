    ...
    <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 sm:py-0 dark:bg-gray-800 dark:border-gray-700">
      <nav className="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
        <div className="flex items-center justify-between">
          <a href="#" className="flex tracking-widest text-[#e6bc5a] font-bold text-xl">
            <span>
              Elmajd FZE LLC 
            </span>
        ...
        <div className={`hs-collapse ${isCollapsed ? 'hidden' : 'block'} overflow-hidden transition-all duration-300 sm:block`}>
          <div className="flex flex-col  items-center mx-auto gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:ps-7">
            ...
            <a className="font-bold text-[#3b4f34] hover:text-[#9b7b32] sm:py-6 dark:text-gray-400 dark:hover:text-[#3b4f34]" href="#brands">Brands</a>
            <a className="font-bold text-[#3b4f34] hover:text-[#9b7b32] sm:py-6 dark:text-gray-400 dark:hover:text-[#3b4f34]" href="#contacts">Contacts</a>
            <a className="font-bold text-[#3b4f34] hover:text-[#9b7b32] sm:py-6 dark:text-gray-400 dark:hover:text-[#3b4f34]" href="#opening-hours">Opening Hours</a>
          </div>
        </div>
      </nav>
    </header>
